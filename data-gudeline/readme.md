...
いかがでしたでしょうか。この記事を通じてみなさまの「安心安全のデータ活用」に少しでも貢献できれば幸いです。蛇足になりますが、グローバルな多言語の協業体制の場合、この記事で用いたレベルの用語（例えば第三者提供 = provision to a third party など）については英訳をチーム内で共有しておくこともおすすめです。
