...
안녕하세요, 저는 일본인 엔지니어 Nakayama입니다. 이 글에서는 생성 AI 연계 애플리케이션 개발을 통해 직면한 과제, 예를 들어 어뷰즈 대응이나 프롬프트 튜닝에서의 시행착오와 트레이드오프에 어떻게 대응했는지 소개합니다. 한국어로 다소 부자연스러운 표현이 포함될 수 있으니 양해 부탁드립니다。
