...
- The second response must be written for the Respondent's colleagues or friends. The grammatical subject must be the colleagues or friends, and when referring to the Respondent, always use the specific term, which is the literal translation of "Respondent" in {{lang}}, and do not use pronouns like "you" in {{lang}}.
