...
とすることもあるかもしれませんが、ホワイトボードを活用した議論に近しい効果を期待するならば、パワーポンチにコストをかけることはお勧めです。
...
参加者は些細な質問でプレゼンテーションの腰を折りたくないとは思いつつも、違和感や不明点を残したままにしておくことにストレスを感じています。そこで論点が切り替わるタイミングで、それとわかるような（例えば通常のスライドに対して前景色と背景色を入れ替えた）スライドを挿入し、同時に進捗状況も可視化してみましょう。
...
さらに、ストレージへのデータ蓄積を表現する際、Ｂの円柱ならばグラデーション塗りつぶしを使わなくても、円柱の重ね合わせで蓄積や割合を表現することができます。結論としてＢの円柱を使っておいた方が良さそうです。
