...
しかし、グローバル協業体制や働き方が多様化した状況下では、関係者が随時集合するわけにはいきません。加えて私たち LINE ヤフーの場合、旧組織間のナレッジや文化の融合途上でもあります。以前のように、ホワイトボードを活用した議論であらゆるギャップを解消してゆきたいところですが、日常的にはオンラインコミュニケーションの質を高めてゆく必要があります。
...
参加者は些細な質問でプレゼンテーションの腰を折りたくないとは思いつつも、わからない部分を残したままにしておくことにストレスを感じ、集中力も低下してゆきます。そこで論点が切り替わるタイミングで、それとわかるような（例えば通常のスライドに対して前景色と背景色を入れ替えた）スライドを挿入し、同時に進捗状況も示すことで
...
意図的にタイミングを作ることで双方向性を促進し、参加者の疑問点を解消したり新しいアイデアを引き出しましょう。
