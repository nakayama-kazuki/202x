...
なお、条件分岐や多段プロンプトの対応は先送りでもよさそうですが、メタ情報については初期段階から考慮することにしました。例えば 40 代男性と 10 代女性では、同じニュースに対しても着眼点は異なるかもしれません。また、レストランに関する SNS ポストの場合、ブリーフィングを掲出するタイミングの天気や時間帯によって、訴求軸を変えたくなるかもしれません。
